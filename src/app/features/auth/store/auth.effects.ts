  ...
  signOutSuccess$ = createEffect(() =>
    this._actions.pipe(
      ...
      map(() => {
        ...
        this._messageService.add({ severity: "info", summary: "Info", detail: "Signed out successfully" });
        return { type: "DUMMY" };
      }),
    ),
  );
  ...
  success$ = createEffect(() =>
    this._actions.pipe(
      ...
      map(() => {
        ...
        this._messageService.add({ severity: "success", summary: "Success", detail: "Signed in successfully" });
        return { type: "DUMMY" };
      }),
    ),
  );
