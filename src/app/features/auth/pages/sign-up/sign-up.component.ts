...
export default class SignUpComponent implements OnInit {
  ...
  public passwordRequirements: PasswordRequirement[] = [
    { validator: "hasMinLength", message: "At least 8 characters", valid: false },
    { validator: "hasUppercase", message: "Needs at least one uppercase letter", valid: false },
    { validator: "hasLowercase", message: "Needs at least one lowercase letter", valid: false },
    { validator: "hasNumber", message: "Needs at least one number", valid: false },
  ];
