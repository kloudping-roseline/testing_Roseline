        ...
        <div class="grid">
          @for (item of products(); track item.id_product; let i = $index) {
            ...
            <div class="flex flex-column justify-content-center align-items-center w-12 h-30rem">
              ...
              <p-button label="Back to shop" routerLink="/tienda/pagina/1" />
...
export default class ShopComponent implements OnInit {
  ...
  public readonly emptyMessage = {
    shop: "There are no products",
    shopCategory: "There are no products in this category",
    shopSubcategory: "There are no products in this subcategory",
    shopBrand: "There are no products from this brand",
